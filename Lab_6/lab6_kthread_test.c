...
int thread_init(void)
{
        ...
        Selected_pin = (unsigned long*) ioremap( (0x3f200000), 4096 );

	GP_SET = Selected_pin + 7;
	GP_CLEAR = Selected_pin + 10;

	iowrite32( (*Selected_pin | 0x00040040 ), Selected_pin );
	iowrite32( (*Selected_pin | 0x00000044 ), Selected_pin );
